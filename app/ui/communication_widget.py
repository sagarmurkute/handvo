"""Premium Accessible Communication Board UI for HANDVO."""
...
class CommunicationWidget(QWidget):
    ...
    6 category navigation tabs, large high-contrast phrase cards, and
    full integration with the hand dwell selection engine.
    """
    ...
    def _init_ui(self) -> None:
        ...
        self.lbl_message.setFont(QFont("Segoe UI", 16, QFont.Weight.DemiBold))
        ...
        self.btn_speak.setMinimumHeight(46)
        ...
        self.btn_backspace.setMinimumHeight(46)
        ...
        self.btn_space.setMinimumHeight(46)
        ...
        # -------------------------------------------------------------
        # 3. Responsive Accessible Phrase Card Grid
        # -------------------------------------------------------------
        ...
        self.phrase_grid.setSpacing(12)
    ...
    def _update_category_tab_styles(self, active_id: str) -> None:
        for btn in self.category_buttons:
            ...
            if cat_id == active_id:
                btn.setStyleSheet(f"font-weight: bold; border-width: 2px;")
    ...
    def _populate_phrase_grid(self) -> None:
        ...
        # Clean up existing phrase buttons
        ...
        for idx, item in enumerate(items):
            ...
            btn_phrase.setMinimumHeight(86)
    ...
    def register_all_targets(self) -> None:
        """Register all action buttons, category tabs, and phrase cards into DwellSelector."""
    ...
    def update_all_dwell_feedbacks(
        ...
        """Update live hover/dwell visual feedback across all registered buttons."""
